	...
	<div class="input-group bg-light pl-4 pt-3 pb-3" id="barraInformacaoTopo">
		<div>
			<div class="text-muted">
				<article> Administrador: Principais Mensagens </article>
			</div>
		</div>
	</div>
		            	...
		            	<div class="card efeito-sombreamento">
			                ...
			                <div class="card-body">
			                    ...
			                    <article class="descricao-produto">
			                        <p class="card-text"> <?php echo $row_extensao['DESCRICAO']; ?> </p> <br>
			                    </article>
			                    <div class="btn-group">
			                    	<?php echo "<a class='btn btn-warning' style='background-color: #f19101; float: left;' href='editarProjeto.php?id=".$row_extensao['CODEXTENSAO']."'>Editar</a>"; ?> 
			                    	<?php echo "<a class='btn btn-warning' style='background-color: #f19101; float: left;' href='apagarProjeto.php?id=".$row_extensao['CODEXTENSAO']."'>Apagar</a>"; ?>
			                    </div>
