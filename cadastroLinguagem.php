...
<body>
	...
	<div class="container">
		<section class="jumbotron">
			<h1> Insira uma nova Linguagem </h1>
			<?php if($msg=="sucesso"): ?>
			<p style="color: red"> Linguagem cadastrada com sucesso! </p>
			<?php else: ?>
			<div class="row">
				<div class="col-lg-7 card-container">
					<div class="card">
						<div class="card-body">
							<form enctype="multipart/form-data" method="POST" action="inLinguagem.php" name="enviarDados">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="subtitulo"  id="inputSubtitulo" placeholder="Digite o subtítulo" required>
								</div>
								<div class="form-group">
									<label for="textAreaDescricao"> Descrição: * </label>
									<textarea class="form-control" id="textAreaDescricao" name="desc" rows="3" required></textarea>
								</div>
								<div class="form-group">
									...
									<input type="submit" class="btn btn-warning" style="background-color: #f19101; float: right;" name="enviar" value="Cadastrar" >
								</div>
							</form>
						</div>
					</div>
