...
<body>	<!--Cabeçalho --> 
	...
	<div class="container">
		<section class="jumbotron">
			...
			<?php if($msg=="sucesso"): ?>
			<p style="color: red"> Curso cadastrado com sucesso! </p>
			<?php else: ?>
			<div class="row">
				<div class="col-lg-7 card-container">
					<div class="card">
						<div class="card-body">
							<form enctype="multipart/form-data" method="POST" action="inCurso.php" name="enviarDados">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="inputSubtitulo" placeholder="Digite o subtítulo" required name="subtitulo">
								</div>
								<div class="form-group">
								...
								<div class="form-group border border-left-0 border-right-0 pt-2 pb-3">
									...
									<select class="form-control" id="selectAssunto" name="linguagem">
									<option selected=""> Selecione </option>
										<?php 
											...
											while($row_linguagem = mysqli_fetch_assoc($resultado_linguagem)){  ?>
												<option value='<?php echo $row_linguagem['CODLIN']; ?>'> <?php echo $row_linguagem['NOMELINGUAGEM']; ?> </option>
										<?php } ?>
									</select>
								</div>
								<div class="form-group">
									<label for="inputValor"> Valor Incial: * </label>
									<input type="text" class="form-control" id="inputValor" placeholder="Apenas valores inteiros" required name="valorInicial" onkeyup="somenteNumeros(this);" maxlength="4">
								</div>
								<div class="form-group">
									<label for="inputPromocao"> Desconto: * </label>
									<input type="text" class="form-control" id="inputPromocao" placeholder="Apenas valores inteiros" required name="valorPromocional" onkeyup="somenteNumeros(this);" maxlength="4">
								</div>
								<div class="form-group border border-left-0 border-right-0 pt-2 pb-3">
									<label for="inputDuracao"> Duração: *</label>
									<input type="text" class="form-control" id="inputPromocao" placeholder="Digite a duração do curso" required name="duracao" onkeyup="somenteNumeros(this);" maxlength="2"> 
								</div>
								<div class="form-group">
									<label for="inputAnexo"> Anexar Imagem </label>
