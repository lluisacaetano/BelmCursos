	...
	<div class="input-group bg-light pl-4 pt-3 pb-3" id="barraInformacaoTopo">
		<div>
			<div class="text-muted">
				<article> Administrador: Listagem das Linguagens </article>
			</div>
		</div>
	</div>
	        ...
	        <div class="row">
	            ...
	            <form  class="col-md-4" method="post">
	            	<div class="card mb-4 shadow-sm">
		                <a href="#">
		                    <img class="card-img-top" src="<?php echo "./imagens/".$row_linguagem['NOMEIMAGEM']; ?>" alt="Card image cap">
		                </a>
		                <div class="card-body">
		                    <h4 class="card-title"> <?php echo $row_linguagem['NOMELINGUAGEM']; ?> </h4>
		                    <article class="descricao-produto">
		                        <p class="card-text"> <?php echo $row_linguagem['DESCRICAO']; ?> </p> <br>
		                    </article>
		                    <div class="btn-group">
		                    	<?php echo "<a class='btn btn-warning' style='background-color: #f19101; float: left;' href='editarLinguagem.php?id=".$row_linguagem['CODLIN']."'>Editar</a>"; ?> &nbsp; 
			                    <?php echo "<a class='btn btn-warning' style='background-color: #f19101; float: left;' href='apagarRegistroLinguagem.php?id=".$row_linguagem['CODLIN']."'>Apagar</a>"; ?>
		                    </div>
		                    <small class="text-muted" style="float: right;"> Código: <?php echo $row_linguagem['CODLIN'] ?> </small>
		                </div>
	                </div>
	            </form>
	            <?php } ?>
